    ...
    <footer className="bg-slate-50 dark:bg-gray-800 border-t border-slate-200 dark:border-gray-700 transition-colors duration-300">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <div className="flex items-center">
              <CodeForgeLogo size={6} className="" />
              <span className="font-bold text-xl text-slate-800 dark:text-white ml-2">CodeForge</span>
            </div>
        ...
        <div className="mt-12 border-t border-slate-200 dark:border-gray-700 pt-8 text-center">
          <p className="text-base text-slate-500 dark:text-gray-400">&copy; {new Date().getFullYear()} CodeForge. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
