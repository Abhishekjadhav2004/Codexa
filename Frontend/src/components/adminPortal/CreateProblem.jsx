...
const codeLanguages = ["cpp", "java", "javascript"];
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const payload = {
        ...
        // Simplified: only initial code per language, map header/main to empty for compatibility
                          ...
                          <div key={field.id} className={subCardClasses}>
                              ...
                              <div className="space-y-4">
                                  ...
                                  <div>
                                      ...
                                      <textarea {...register(`starterCode.${index}.code`, { required: 'Initial code is required' })} className={`${inputBaseClasses} font-mono text-sm min-h-[150px]`} placeholder="e.g., class Solution { /* complete this */ }" />
