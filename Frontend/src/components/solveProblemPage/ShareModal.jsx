...
const ShareModal = ({ isOpen, onClose, problem }) => {
  ...
  const shareTextForSocial = `Check out the problem: "${problemTitle}" on CodeForge!`;
  const shareMessageForCopy = `I'm working on the "${problemTitle}" problem on CodeForge!\nCheck it out: <${problemUrl}>`;
