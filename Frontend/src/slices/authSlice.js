...
//   async (userData, {rejectWithValue}) => {
//     try {
//       const response = await axiosClient.post("/api/authentication/register", userData);
//       return response.data.user;
//     } catch (error) {
//       return rejectWithValue(error.response?.data?.message || "Something went wrong");
//     }
...
//   async (credentials, {rejectWithValue}) => {
//     try {
//       const response = await axiosClient.post("/api/authentication/login", credentials);
//       return response.data.user;
//     } catch (error) {
//       return rejectWithValue(error.response?.data?.message || "Something went wrong");
//     }
...
// // authenticate user
// export const authenticateUser = createAsyncThunk('auth/check',
//   async (_, {rejectWithValue}) => {
//     try {
//       const response = await axiosClient.get("/api/authentication/check");
//       return response.data.user;
//     } catch (error) {
//       return rejectWithValue(error.response?.data?.message || "Something went wrong");
//     }
