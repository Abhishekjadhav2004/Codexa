...
import { CodeForgeLogo } from "../components"
  ...
  return (
    <div className="max-w-5xl mx-auto py-8">
      <header className="text-center mb-16 relative">
        <CodeForgeLogo className="absolute inset-0 w-full h-full text-slate-200/30 dark:text-slate-800/40 -z-10 transform scale-150" />
        ...
        <div className="flex justify-center items-center">
          <div className="bg-[#ffffff] dark:bg-[#232b3b] p-8 rounded-xl border border-[#e2e8f0] dark:border-[#334155]">
            ...
            <p className="text-[#475569] dark:text-[#94a3b8] leading-relaxed">
              ...
              of solution spoilers. CodeForge was built to solve these challenges by providing a one-stop platform
      ...
      <section className="bg-[#ffffff] dark:bg-[#232b3b] rounded-xl p-8 md:p-12 border border-[#e2e8f0] dark:border-[#334155] mb-10">
        ...
        <div className="max-w-md mx-auto bg-[#f8fafc] dark:bg-[#1a2332] rounded-lg p-6 text-center shadow-lg">
          ...
          />
          <h3 className="text-2xl font-bold text-[#1e293b] dark:text-[#e2e8f0]">Abhi jadhav</h3>
          <p className="text-[#f97316] font-semibold mb-3">Full Stack Developer</p>
          <p className="text-[#475569] dark:text-[#94a3b8] mb-4">
            The mind and muscle behind CodeForge ,Abhi is a passionate developer dedicated to creating tools that
            empower other coders. He built CodeForge to solve the common hurdles faced by learners in the tech space.
          </p>
          <div className="flex justify-center space-x-4">
            <a href="https://github.com/Abhishekjadhav2004" target="_blank" aria-label="Github Profile" className="text-slate-500 hover:text-[#f97316]">
              <Github size={24} />
            </a>
            <a href="https://www.linkedin.com/authwall?trk=bf&trkInfo=AQFUcLrSBX3kLgAAAZnJhpsQymVBbk1lD3ce3rL1t5uvcdM77dYgmVr1ZiQqoGAFXaI4lm3kSe4D5fltE-INyO5LFbfG58gMIxqd4Hf20zPWVPjexu9lc_YkeRQ9vIBDgAPWCWc=&original_referer=&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fin%2Fabhishek-jadhav-0812ab2a3%3Flipi%3Durn%253Ali%253Apage%253Ad_flagship3_profile_view_base_contact_details%253BFo6NTmN1SZesIVIEHs%252B9eg%253D%253D" target="_blank" aria-label="LinkedIn Profile" className="text-slate-500 hover:text-[#f97316]">
              <Linkedin size={24} />
            </a>
          </div>
        </div>
